...
class MainHomePageScreen extends StatefulWidget {
  ...
  MainHomePageScreen({this.userId, this.user, this.currentUserId});
        ...
        Column(
          children: <Widget>[
            IconButton(
              icon: Icon(
                Icons.live_tv,
                color: _displayPosts == 2 ? Colors.red : Colors.redAccent[600],
              ),
              iconSize: 40.0,
              color: _displayPosts == 0 ? Colors.redAccent[300] : Colors.red,
              onPressed: () => setState(() {
                _displayPosts = 2;
              }),
            ),
            Text(
              ...
              style: TextStyle(
                  color:
                      _displayPosts == 2 ? Colors.red : Colors.redAccent[600]),
            )
          ],
        ),
        Column(
          children: <Widget>[
            IconButton(
              icon: Icon(
                Icons.school,
                color: _displayPosts == 3 ? Colors.red : Colors.redAccent[600],
              ),
              iconSize: 40.0,
              color: _displayPosts == 0 ? Colors.redAccent[300] : Colors.red,
              onPressed: () => setState(() {
            ...
            Text(
              ...
              style: TextStyle(
                  color:
                      _displayPosts == 3 ? Colors.red : Colors.redAccent[600]),
            )
          ],
        ),
        Column(
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                  color:
                      _displayPosts == 4 ? Colors.red : Colors.redAccent[600]),
            )
          ],
        ),
      ],
